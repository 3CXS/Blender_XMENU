...
def register():
    ...
    bpy.types.Brush.xm_use_mask = BoolProperty(default=True,update=mute_ramp)
    ...
    bpy.types.Brush.xm_invert_stencil_mask = BoolProperty(default=True,update=invert_stencil_ramp)
