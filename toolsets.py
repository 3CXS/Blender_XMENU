...
def toolset():
    if bpy.context.mode == 'OBJECT':
        ...
        Toolset = Tools_Curve_Edit
    else:
        Toolset = None
    return Toolset

#---------------------------------------------------------------------------------------------------------------------------------------------
                # LABEL                 ICON                                PRESET-NAME      OPERATOR                            CUSTOM-ICON
#---------------------------------------------------------------------------------------------------------------------------------------------
Tools_Object= [ 
                ('',                    '',                                 '',             '',                                 ''),
                ...
                ('LASSO',               'builtin.select_lasso',             '',             'ops.generic.select_lasso',         'LASSO_SEL'),
                ('CURSOR',              'builtin.cursor',                   '',             'ops.generic.cursor',               'CURSOR'),
                ('MOVE',                'builtin.move',                     '',             'ops.transform.translate',          'MOVE'),
                ('ROTATE',              'builtin.rotate',                   '',             'ops.transform.rotate',             'ROTATE'),
                ('SCALE',               'builtin.scale',                    '',             'ops.transform.resize',             'SCALE'),
                ('TRANSFORM',           'builtin.transform',                '',             'ops.transform.transform',          'TRANSFORM'),
...
Tools_Edit = [
                ...
                ('EXT N',            'builtin.extrude_along_normals',    '',             'ops.mesh.extrude_region_shrink_fatten', ''),
                ('IND',             'builtin.extrude_individual',       '',             'ops.mesh.extrude_faces_move',      ''),
                ('EXT CRS',             'builtin.extrude_to_cursor',        '',             'ops.mesh.dupli_extrude_cursor',    ''),

                ('INS',               'builtin.inset_faces',              '',             'ops.mesh.inset',                   ''),
                ('BVL',               'builtin.bevel',                    '',             'ops.mesh.bevel',                   ''),
                ...
                ('EDG',             'builtin.edge_slide',               '',             'ops.transform.edge_slide',         ''),
                ('SLIDE V',             'builtin.vertex_slide',             '',             'ops.transform.vert_slide',         ''),
                ('SHRNK',              'builtin.shrink_fatten',            '',             'ops.transform.shrink_fatten',      ''),
